...
fn test_buy_check_balance_and_withdraw() {
    ...
    let purchase_result = dispatcher
        .buy_product(1, 2, 300, ONE_TOKEN * 3); // Buy 2 apples, provide 3 STRK tokens as payment
    ...
    assert(
        balance_after_withdrawal == balance_after_purchase - withdrawal_amount,
